        ...
        <div>
            <div className = "introduction">
                ...
                <h2>
                    ...
                    Feel free to take a look around and explore to learn more about me and stay tuned for future updates to this website!
                </h2>
            </div>
            <div className = "polaroid-images">
                <div className = "double-stacked">
                    <div className = "polaroid-container">
                        ...
                        <div className = "polaroid-caption"> My dog: Macho </div>
                    </div>
                    <div className = "polaroid-container">
                        <img src = {LunaPhoto} alt = "My dog: Luna"/>
                        <div className = "polaroid-caption"> My dog: Luna </div>
                    </div>
                </div>
                <div className = "double-stacked">
